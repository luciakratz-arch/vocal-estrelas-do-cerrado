...
function BlogGrupo(_ref55) {
  ...
  var _useState205 = useState(null),
    ...
    modal = _useState206[0],
    setModal = _useState206[1];
  var _useState207 = useState({
    ...
    form = _useState208[0],
    setForm = _useState208[1];
  var _useState209 = useState(false),
    _useState210 = _slicedToArray(_useState209, 2),
    salvando = _useState210[0],
    setSalvando = _useState210[1];
  var _useState211 = useState(""),
    _useState212 = _slicedToArray(_useState211, 2),
    erro = _useState212[0],
    setErro = _useState212[1];
  var _useState213 = useState("Todos"),
    _useState214 = _slicedToArray(_useState213, 2),
    filtro = _useState214[0],
    setFiltro = _useState214[1];
  var cor = config.corPrimaria || COR;
...
function App() {
  var _useState215 = useState(function () {
    ...
    user = _useState216[0],
    setUser = _useState216[1];
  var _useState217 = useState([]),
    _useState218 = _slicedToArray(_useState217, 2),
    members = _useState218[0],
    setMembers = _useState218[1];
  var _useState219 = useState("painel"),
    _useState220 = _slicedToArray(_useState219, 2),
    tab = _useState220[0],
    setTab = _useState220[1];
